              ...
              {message.role === 'user' ? (
                ...
                <div className="media-card image-card">
                  <div
                    ...
                    onClick={() => setLightboxImage({ src: message.media!.dataUrl, alt: message.content || 'Generated image', fileName: message.media!.fileName || 'personal-ai-image.jpg' })}
                  ...
                  <div className="media-card-actions">
                    <button
                      ...
                      onClick={() => downloadMedia(message.media!.dataUrl, message.media!.fileName || 'personal-ai-image.jpg')}
                ...
                <div className="media-card audio-card">
                  ...
                  <div className="media-card-actions">
                    <button
                      type="button"
                      className="media-download-button"
                      onClick={() => downloadMedia(message.media!.dataUrl, message.media!.fileName || 'personal-ai-music.mp3')}
